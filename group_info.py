...
kinder=[
    [{"ילדי גן": []}],
    [{"סבא וסבתא": ["סבא", "נכדתו", "סבַּאָ"]}],
    [{"פחדי ילדים": ["פּחְדָיִם", "חַרֲדָוֹת"]}],
    [{"בעלי חיים לילדים": ["חַתֲוּליִם", "חָתוּל" "קיפוד", "שועלה", "תיש" "קרנף", "זיקית", "קוֹף", "נָמֵר" "פיל", "דָּג", "כלבלב", "כֶּלֶב", "כלבה", "צָב", "אַרְנָב", "דְּבוֹרָה", "תּוֹלַעַת", "חַיּוֹת", "פִּינְגְוִין"]}],
    [{"יום הולדת לילדים": ["יום הולדת", "יומולדת"]}],
]
